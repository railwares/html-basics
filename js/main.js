...
document.addEventListener('DOMContentLoaded', () => {
  initActiveNav(); initMenuToggle(); initThemeToggle();
  initBackToTop(); initAccordion(); initFilters();
  initModal(); initContactForm();
});

// Функції-помічники для скорочення коду (замінюють document.querySelector)
